...
|----------|------------------|----------------|
| Dim_Facility | Hospital identity & region | Facility comparison & care distribution |
| Dim_AdmissionType | How/why the stay began | Unplanned burden & ED flow analysis |
| Dim_Disposition | Where the patient went after discharge | Care continuity, readmissions, population tracking |
| Dim_Payer | Insurance category | Cost burden & reimbursement analysis |
| Dim_ClinicalClass | APR-DRG clinical grouping | Risk stratification & case-mix comparison |
